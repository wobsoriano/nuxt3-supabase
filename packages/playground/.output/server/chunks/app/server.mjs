import { v as vue_cjs_prod, s as shared, r as reactivity, a as serverRenderer } from '../index.mjs';
import * as __WEBPACK_EXTERNAL_MODULE_hookable__ from 'hookable';
import * as require$$0 from 'unenv/runtime/mock/proxy';
import * as __WEBPACK_EXTERNAL_MODULE__supabase_supabase_js_51b752d5__ from '@supabase/supabase-js';
...
module.exports = x({ ["computed"]: () => reactivity.exports.computed });
...
var x = y => { var x = {}; __webpack_require__.d(x, y); return x; };
module.exports = x({ ["Suspense"]: () => vue_cjs_prod.Suspense, ["Transition"]: () => vue_cjs_prod.Transition, ["createApp"]: () => vue_cjs_prod.createApp, ["createBlock"]: () => vue_cjs_prod.createBlock, ["createCommentVNode"]: () => vue_cjs_prod.createCommentVNode, ["createVNode"]: () => vue_cjs_prod.createVNode, ["defineComponent"]: () => vue_cjs_prod.defineComponent, ["getCurrentInstance"]: () => vue_cjs_prod.getCurrentInstance, ["h"]: () => vue_cjs_prod.h, ["inject"]: () => vue_cjs_prod.inject, ["onBeforeUnmount"]: () => vue_cjs_prod.onBeforeUnmount, ["openBlock"]: () => vue_cjs_prod.openBlock, ["reactive"]: () => vue_cjs_prod.reactive, ["ref"]: () => vue_cjs_prod.ref, ["resolveComponent"]: () => vue_cjs_prod.resolveComponent, ["resolveDynamicComponent"]: () => vue_cjs_prod.resolveDynamicComponent, ["shallowRef"]: () => vue_cjs_prod.shallowRef, ["unref"]: () => vue_cjs_prod.unref, ["watchEffect"]: () => vue_cjs_prod.watchEffect, ["withAsyncContext"]: () => vue_cjs_prod.withAsyncContext, ["withCtx"]: () => vue_cjs_prod.withCtx });
...
var x = y => { var x = {}; __webpack_require__.d(x, y); return x; };
module.exports = x({ ["RouterLink"]: () => vueRouter_cjs.RouterLink, ["createMemoryHistory"]: () => vueRouter_cjs.createMemoryHistory, ["createRouter"]: () => vueRouter_cjs.createRouter });
...
var x = y => { var x = {}; __webpack_require__.d(x, y); return x; };
module.exports = x({ ["ssrInterpolate"]: () => serverRenderer.exports.ssrInterpolate, ["ssrRenderAttrs"]: () => serverRenderer.exports.ssrRenderAttrs, ["ssrRenderComponent"]: () => serverRenderer.exports.ssrRenderComponent, ["ssrRenderSuspense"]: () => serverRenderer.exports.ssrRenderSuspense, ["ssrRenderVNode"]: () => serverRenderer.exports.ssrRenderVNode });
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "w3": () => (/* reexport */ asyncData_useAsyncData),
  "e": () => (/* reexport */ nuxt_useNuxtApp)
});

// UNUSED EXPORTS: NuxtPluginIndicator, applyPlugin, callWithNuxt, defineNuxtComponent, isLegacyPlugin, setNuxtAppInstance, useFetch, useHydration, useRuntimeConfig, useState
...
var proxy_x = y => { var x = {}; __webpack_require__.d(x, y); return x; };
const proxy_namespaceObject = proxy_x({ ["default"]: () => require$$0["default"] });

function mock(warning) {
  console.warn(warning);
  return proxy_namespaceObject["default"];
}
...
function asyncData_useAsyncData(key, handler, options = {}) {
  ...
  const nuxt = nuxt_useNuxtApp();
  const instance = (0, external_vue_.getCurrentInstance)();
  if (!instance._nuxtOnBeforeMountCbs) {
    instance._nuxtOnBeforeMountCbs = [];
  }
  const asyncData = {
    data: (0, external_vue_.ref)(nuxt.payload.data[key] ?? options.default()),
    pending: (0, external_vue_.ref)(true),
    error: (0, external_vue_.ref)(null)
  };
...
/******/ 						var promise = import('../_dynamic-require.mjs').then(r => r.default || r).then(dynamicRequire => dynamicRequire( __webpack_require__.u(chunkId))).then(installChunk, (e) => {
...
var dist_app = __webpack_require__(397);

/* harmony default export */ const preload_server = ((0, dist_app/* defineNuxtPlugin */.fm)(({ app }) => {
  app.mixin({
    beforeCreate() {
...
/* harmony default export */ const vueuse_head_plugin = ((0, dist_app/* defineNuxtPlugin */.fm)((nuxt) => {
...
var x = y => { var x = {}; __webpack_require__.d(x, y); return x; };
const shared_namespaceObject = x({ ["isFunction"]: () => shared.exports.isFunction });
// EXTERNAL MODULE: external "@vue/reactivity"
var reactivity_ = __webpack_require__(969);



function useMeta(meta) {
  const resolvedMeta = (0, shared_namespaceObject.isFunction)(meta) ? (0, reactivity_.computed)(meta) : meta;
  (0, dist_app/* useNuxtApp */.e)()._useMeta(resolvedMeta);
}
...
/* harmony default export */ const runtime_plugin = ((0, dist_app/* defineNuxtPlugin */.fm)((nuxt) => {
...
const __exports__ = /*#__PURE__*/(0, exportHelper/* default */.Z)(pagevue_type_script_lang_js, [['ssrRender',ssrRender]]);

/* harmony default export */ const page = (__exports__);
...
/* harmony default export */ const router = ((0, dist_app/* defineNuxtPlugin */.fm)((nuxt) => {
  const { app } = nuxt;
  app.component("NuxtPage", page);
  app.component("NuxtLayout", layout);
  app.component("NuxtLink", external_vue_router_.RouterLink);
  const routerHistory =  (0, external_vue_router_.createMemoryHistory)();
...
var supabase_js_x = y => { var x = {}; __webpack_require__.d(x, y); return x; };
const supabase_js_namespaceObject = supabase_js_x({ ["createClient"]: () => __WEBPACK_EXTERNAL_MODULE__supabase_supabase_js_51b752d5__.createClient });
const supabaseOptionsObj_22c4db9e = () => Promise.resolve({ "supabaseUrl": "https://vwqscxqytalithhwlrjw.supabase.co", "supabaseKey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYyOTA5ODAwOCwiZXhwIjoxOTQ0Njc0MDA4fQ.dnOA5mc9JjNx-ivN8ZxoD3kfaqtI18npAyAuqwkT3wM" });
/* harmony default export */ const supabase_options = (supabaseOptionsObj_22c4db9e);



const plugin_plugin = (0, dist_app/* defineNuxtPlugin */.fm)(async (nuxtApp) => {
  const loadedOptions = await supabase_options();
  const { supabaseKey, supabaseUrl, supabaseOptions } = loadedOptions;
  const supabase = (0, supabase_js_namespaceObject.createClient)(supabaseUrl, supabaseKey, supabaseOptions);
  nuxtApp.provide("supabase", supabase);
});
var external_ohmyfetch_x = y => { var x = {}; __webpack_require__.d(x, y); return x; };
const external_ohmyfetch_namespaceObject = external_ohmyfetch_x({ ["$fetch"]: () => __WEBPACK_EXTERNAL_MODULE_ohmyfetch__.$fetch });
...
function rootvue_type_template_id_3e837ec8_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_App = (0, external_vue_.resolveComponent)("App");

  _push((0, server_renderer_.ssrRenderComponent)(_component_App, _attrs, null, _parent));
}
...
;
const root_exports_ = /*#__PURE__*/(0, exportHelper/* default */.Z)(script, [['ssrRender',rootvue_type_template_id_3e837ec8_ssrRender]]);

/* harmony default export */ const root = (root_exports_);




function dist_ruleSet_0_appvue_type_template_id_0def4f02_ssrRender(_ctx, _push, _parent, _attrs) {
...
;
const app_exports_ = /*#__PURE__*/(0, exportHelper/* default */.Z)(app_script, [['ssrRender',dist_ruleSet_0_appvue_type_template_id_0def4f02_ssrRender]]);
...
let entry;
const plugins = (0, dist_app/* normalizePlugins */.YB)(server);
{
  entry = async function createNuxtAppServer(ssrContext = {}) {
    const app = (0, external_vue_.createApp)(root);
    app.component("App", app_0);
    const nuxt = (0, dist_app/* createNuxtApp */.dX)({ app, ssrContext });
    await (0, dist_app/* applyPlugins */.zd)(nuxt, plugins);
